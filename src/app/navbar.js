...
export default function Navbar() {
  ...
  function click() {
    if (toggle === "hidden") setToggle("click");
  ...
  return (
    <div>
      <nav class="relative px-4 py-6 lg:py-10 flex justify-between items-center bg-black">
        <a class="text-3xl font-bold leading-none lg:hidden" href="#">
          <div class="" alt="logo" viewBox="0 0 10240 10240">
        ...
        <ul class="hidden absolute top-1/2 left-0 transform -translate-y-1/2 translate-x-3 lg:flex lg:mx-auto lg:items-le lg:w-auto lg:space-x-6 sm:space-x-3">
          <li className="">
            <a class="text-3xl font-bold leading-none" href="#">
              <div
                class="relative h-10 w-28 "
                alt="logo"
          ...
          <li className="pt-1">
            <a
              class="text-sm text-gray-400 font-bold hover:text-gray-500"
              href="/motor"
            >
              MotorBiker
            </a>
        ...
        <a
          class="hidden sm:ml-auto sm:mr-3 lg:mr-3 py-2 px-6 bg-gray-50 hover:bg-gray-100 text-sm text-gray-900 font-bold  rounded-xl transition duration-200"
          href="#"
        >
          Sign In
        </a>
        <a
          class="hidden py-2 px-6 bg-blue-500 hover:bg-blue-600 text-sm text-white font-bold rounded-xl transition duration-200"
          href="#"
        >
          Download for PC
        </a>
      </nav>
      <div class={`navbar-menu relative z-50 ${toggle}`}>
        <div
          onClick={click}
