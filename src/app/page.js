...
const Intro = () => {
  return (
    ...
    >
      <div className="flex flex-col flex-wrap px-7 items-center lg:w-800 w-full m-auto text-center text-slate-50">
        <h2
        ...
        <div className="lg:text-2xl">
          ...
          <div className="flex items-center justify-center">
            <a className="" href="#">
              <div className="relative mx-2 w-24 h-24 md:w-36 md:h-36">
                <Image fill src="/home/link1.svg"></Image>
              </div>
            </a>
            <a href="#">
              <div className="relative mx-2 w-24 h-24 md:w-36 md:h-36">
                <Image fill src="/home/link2.svg"></Image>
              </div>
            </a>
            <a href="#">
              <div className="relative mx-2 w-24 h-12 md:w-36 md:h-70">
                <Image fill src="/home/link3.png"></Image>
              </div>
            </a>
          </div>
        </div>
      ...
      <div>
        <ul className="flex text-slate-50 flex-wrap flex-row items-center mt-5 justify-center z-10 relative">
          <ul className="flex py-4">
            <li>
              <a
                className="hover:-translate-y-2 transition ease-in-out delay-50 w-44 h-44 px-2 md:w-72 md:h-72 block"
                href="#community"
              ...
              rgba(96, 23, 54, 0) 72.51%, rgba(96, 23, 54, 0) 91.16%), #0a1626`,
                ...
                >
                  <div className="flex text-center h-full flex-col justify-between">
                    <svg
                      width="100%"
                      height="30%"
                      viewBox="0 0 64 64"
                    ...
                    <div>A UNIFIED GAMING COMMUNITY</div>
                    <svg
                      width="100%"
                      height="20%"
                      viewBox="0 0 16 16"
              ...
              linear-gradient(0deg, #0a1626, #0a1626), #242424`,
                ...
                >
                  <div className="flex text-center h-full flex-col justify-between">
                    ...
                    <div>ANALYTICS AND GUIDANCE</div>
                    <svg
                      width="100%"
                      height="20%"
                      viewBox="0 0 16 16"
              ...
              linear-gradient(0deg, #0a1626, #0a1626), #242424`,
                ...
                >
                  <div className="flex text-center h-full flex-col justify-between">
                    ...
                    <div>INTRODUCING THE ARNEX CONNECT DESKTOP APP</div>
                    <svg
                      width="100%"
                      height="20%"
                      viewBox="0 0 16 16"
...
const Content = () => {
  return (
    <div
      id="community"
      className="relative portrait:py-40 landscape:py-20"
      style={{
    ...
    >
      ...
      <div className="flex flex-wrap justify-center">
        <div className="flex flex-col sm:flex-row portrait:flex-col m-auto justify-center w-100 items-center ">
          <div className="relative flex w-full justify-center my-auto">
            <Image
              width={1000}
              height={1000}
              src="/Anrex Connect Homepage.png"
            />
          </div>
          <div className="w-full relative px-4 text-slate-50">
                ...
                <div className="flex flex-col sm:flex-row portrait:flex-col m-auto justify-center w-100 items-center ">
                  ...
                  <div className="w-full relative px-4 text-slate-50">
                    ...
                    <div className="lg:text-xl">
                      ...
                      of a global community of Arnex gamers, accessing the same
                    ...
                    <div className="lg:text-xl">
                      ...
                      across Arnex Connect, ensuring a smooth transition if you
              ...
              <div className="flex flex-wrap justify-center z-10 relative">
                <div className="flex flex-col sm:flex-row-reverse portrait:flex-col m-auto justify-center w-100 items-center ">
                  ...
                  <div className="w-full relative px-4 text-slate-50">
                    ...
                    <br />
                    <div className="font-bold text-sm lg:text-2xl">
                      Enjoy a 20% discount at the Arnex Store
                    </div>
                    <div className="lg:text-2xl">
                      Exchange 100 Units to receive a 20% discount on your
                      upcoming acquisition from the Arnex Store.*
                    </div>
                    <br />
                ...
                <div className="flex flex-col sm:flex-row-reverse portrait:flex-col m-auto justify-center w-100 items-center ">
                  ...
                  <div className="w-full relative px-4 text-slate-50">
                    <div className="flex py-2 justify-start items-center">
                      ...
                      <span className="font-bold text-xl lg:text-2xl">
                        INTRODUCING THE ARNEX CONNECT DESKTOP APP
                      </span>
                    </div>
                    <div
                      className="text-4xl lg:text-5xl font-bold "
                    ...
                    <div className="lg:text-2xl">
                      ...
                      to the Arnex+ subscription service and delve into a vast
                    ...
                    <div className="lg:text-2xl">
                      ...
                      hosted through the Arnex Connect desktop app, including
                    ...
                    <br />
                    <div className="lg:text-sm text-xs">
                      Both of you need to be Arnex Connect friends and have the
                      Arnex Connect desktop app running
                    </div>
                    <br />
                    <button
                      type="button"
