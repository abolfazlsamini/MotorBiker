...
export default function Footer() {
  return (
    <footer className="footer pt-4">
      <div
        className="h-full px-5 pb-8 sm:pb-10 lg:pb-12 sm:px-8 lg:px-20 w-full"
        style={{
          backgroundImage: "url(circle.avif)",
          // backgroundPosition: "bottom right",
          backgroundPositionY: "110px",
          backgroundPositionX: "calc(100% + 50px)",
          backgroundSize: "600px",
          backgroundRepeat: "no-repeat",
        }}
      >
        <div>
          <ul class="flex justify-start my-5 space-x-5">
            <li className="text-slate-50 pt-2">Follow us</li>
            <li>
              <a
                href="#"
        ...
        <hr class="border-0 border-t-2 mb-9 sm:mb-11 lg:mb-12 border-slate-50"></hr>
        ...
        <div class="bg-ubigray text-xs w-max text-slate-50 p-2 rounded-lg mb-6">
